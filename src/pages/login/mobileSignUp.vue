...
import {registerPhone,getCaptcha} from '../../service/getData'
...
export default {
    ...
    methods:{
        ...
        async sendPhoneReg(){
            var result = await registerPhone(this.phoneParams);
            if(result.code==444){
                Indicator.close();
                Toast({
                    message:result.datas.error,
...
<div class='wrapper'>
    ...
    <p class="signUpEmail"><router-link class="v-link" to='emailSignUp'>sign up VIA Email</router-link></p>
