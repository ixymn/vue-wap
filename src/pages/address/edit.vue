<template>
	<div class="addr-edit-box">
		<HEADBACK headTitle="Edit Address">
		...
		<div class="addredt-main">
			...
			<router-link to="/addressEdit/province" class="v-link">
			...
			<div v-show="hasDeliver">
				...
				<router-link to="/addressEdit/pickup" class="v-link">
...
import {getAddrOne,getPickup,editAddr} from '../../service/getData'
...
export default {
	...
	mounted:function(){
		...
		this.addrItem={"deliver_address":'',"pickup_address":'',...this.addrInfo};
	},
	methods:{
		...
		chooseCity:function(){
			if(!this.addrItem.province_name){
				...
				this.$router.push("/addressEdit/city");
			}
		},
